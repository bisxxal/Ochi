...
function Fotter() {
  return (
    ...
    <div className='w-full h-[97vh] md:h-[102vh] md:overflow-hidden  flex md:flex-col'>
    <div className=' w-1/2 flex   justify-between px-16 md:px-4'>
            <div><h1 className='text-[18vh] font-bold text-[#212121]   leading-[18vh] md:leading-[6vh] md:font-bold md:text-[7vh]'>EYE- OPENING</h1></div>
            
        </div>
        <div className=' w-1/2 flex flex-col  gap-9 px-16 md:px-4'>
        <div><h1 className='text-[10vh] text-[#212121] font-extrabold md:font-bold md:text-[5vh]'>PRESENTATIONS</h1></div>

        <div className='flex  justify-between' >
            <div  className='w-1/2 gap-3 md:gap-1 flex flex-col'>
                <a href="">S:</a>
                {["Instagram","Behance","Facebook","Linkedin","L:"].map((item,index)=>(
                     <a key={index}  >{item}</a>
                ))}
                 
                {["202-1965 W 4th Ave","Vancouver, Canada","30 Chukarina St"," Lviv, Ukraine","E:","hello@ochi.design"].map((item,index)=>(
                     <a key={index}  >{item}</a>
                ))}
            ...
            <div className='w-1/2 gap-3 md:gap-1 flex flex-col'>
                ...
                {["M:","Services","Our Work","About us","Insight","Contact us"].map((item,index)=>(
                    <a key={index} >{item}</a>
                ))} 
...
<div className='flex items-center justify-between px-16 md:items-start md:mt-16 md:gap-6 md:px-4 mb-7 md:flex-col'  >

        <div ><svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='flex gap-9 md:gap-1 md:flex-col'>
            
            <h1>© ochi design 2024.</h1>
              <h1>         Legal Terms  </h1> <h1>Website by Obys</h1> 
</div>
</div>
        </div>
